...
import { Loader2, Bell, UserPlus, MessageCircle, FileText, Target } from "lucide-react";
...
interface Notification {
    ...
    type: 'reply' | 'new_journal' | 'new_resolution' | 'follow';
    refId: string;
    refText: string;
    createdAt: any;
    read: boolean;
...
export function NotificationsTab() {
    ...
    const getLink = (notif: Notification) => {
        ...
        if (notif.type === 'new_journal') return `/${notif.senderUsername}`; // Or maybe a direct link if journals have IDs
                ...
                >
                    ...
                    <div className="flex-1">
                        <p className="text-sm text-slate-800">
                            ...
                            {notif.type === 'new_journal' && "posted a new journal"}
